...
function LPU() {
  ...
  return (
    <div className="university-page lpu">
      {/* Hero Section */}
      <section className="hero blue">
        <div className="container">
          <h1>Lovely Professional University</h1>
          <p>Indias Largest Private University with 30,000+ Students from 50+ Countries</p>
      ...
      <section className="about">
        <div className="container">
          ...
          <p>
            ...
            Law, Design, Agriculture, and more.
          </p>
        </div>
      </section>
      ...
      {/* Placements Section */}
      {placements && (
        <section className="placements blue">
          <div className="container">
      ...
      <section className="apply-section">
        <div className="container">
          <LeadForm universityName="Lovely Professional University" />
        </div>
      </section>
